      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-8 px-6 py-12 max-w-6xl">
        <div className="max-w-xl text-center md:text-left">
          ...
          <p className="text-gray-700">
            ...
            quod veniam possimus et quas iure nam autem, magnam dolorum
            consequatur non recusandae, numquam nisi velit nostrum architecto
            commodi repellendus quibusdam cupiditate. Et amet reprehenderit iure
            ipsum autem excepturi quisquam?
          </p>
        </div>
