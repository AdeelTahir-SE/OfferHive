    ...
    <footer className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white py-10 px-4 bottom-0 relative ">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex items-center justify-center md:justify-start space-x-6  ">
          ...
          <Link href="https://www.instagram.com/offer__hive?utm_source=qr&igsh=Nml0dzV4ZHBqcTZn"  target="_blank" rel="noopener noreferrer">
            <Image src="/instagram.svg" alt="Instagram" width={35} height={35} className="hover:scale-110 transition-transform" />
          </Link>
         <Link href="https://github.com/AdeelTahir-SE"  target="_blank" rel="noopener noreferrer">
            <Image src="/github.svg" alt="GitHub" width={35} height={35} className="hover:scale-110 transition-transform" />
          </Link>
         <Link href="www.linkedin.com/in/adeel-tahir-fullstackdeveoper"  target="_blank" rel="noopener noreferrer">
            <Image src="/linkedIn.svg" alt="LinkedIn" width={35} height={35} className="hover:scale-110 transition-transform" />
          </Link>
        </div>
