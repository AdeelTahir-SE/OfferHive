  ...
  return (
    <section className="flex flex-col items-center justify-center min-h-screen p-6 bg-gray-50">
      ...
      >
        ...
        <button
          type="submit"
          className={`w-full bg-yellow-400 cursor-pointer hover:bg-yellow-500 text-black font-semibold py-2 px-4 rounded-md transition-colors duration-200 ${isSubmitting ? "opacity-50 cursor-not-allowed" : ""}`}
      ...
      <div className="mt-10 text-sm text-gray-500 text-center">
        Or reach us directly at <a href="mailto:adeeltahir6a@gmail.com" className="text-yellow-600 underline">contact@yourwebsite.com</a>
      </div>
    </section>
  );
}
